...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --disable-yasm --prefix=/usr/local/ffmpeg --disable-dxva2
...
CFLAGS-ffplay=-I/usr/local/cross-tools/i386-mingw32msvc/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lavicap32 -lgdi32 -lws2_32 -liconv -lm -lbz2 -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
...
LIBS-ffplay=-L/usr/local/cross-tools/i386-mingw32msvc/lib -lmingw32 -lSDLmain -lSDL -mwindows -mconsole
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
